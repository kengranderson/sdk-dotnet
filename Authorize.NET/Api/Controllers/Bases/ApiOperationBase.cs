...
#pragma warning disable 1591
            ...
            where TS : ANetApiResponse
    {
        ...
        ANetApiResponse _errorResponse;
        ...
        protected ApiOperationBase(TQ apiRequest)
        {
            ...
            Logger.debug($"Creating instance for request:'{_requestClass}' and response:'{_responseClass}'");
        ...
        void SetApiResponse(TS apiResponse)
        {
        ...
        void SetErrorResponse(ANetApiResponse errorResponse)
        {
        ...
        void ValidateAndSetMerchantAuthentication()
        {
            ANetApiRequest request = GetApiRequest();
